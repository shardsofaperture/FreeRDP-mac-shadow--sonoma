...
`/Users/<redacted>/gitr/RDP/FreeRDP-mac-shadow--sonoma`, branch `master`, HEAD
...
The **installed** app remains `/Users/<redacted>/Applications/FreeRDP Shadow.app`,
...
```zsh
cat '/Users/<redacted>/gitr/RDP/FreeRDP-mac-shadow--sonoma/experiments/transport-rate-sweep/RESUME.md'
```
