...
ExternalProject_Add(freerdp
    ...
    BUILD_BYPRODUCTS
        ${DEPS_INSTALL_DIR}/lib/libfreerdp3.so
        ${DEPS_INSTALL_DIR}/lib/libfreerdp-client3.so
...
file(MAKE_DIRECTORY
    ...
    ${DEPS_INSTALL_DIR}/include/freerdp3
    ${DEPS_INSTALL_DIR}/include/winpr3
)

add_library(freerdp3-lib SHARED IMPORTED GLOBAL)
set_target_properties(freerdp3-lib PROPERTIES
    IMPORTED_LOCATION             "${DEPS_INSTALL_DIR}/lib/libfreerdp3.so"
...
set_target_properties(freerdp-client3-lib PROPERTIES
    IMPORTED_LOCATION             "${DEPS_INSTALL_DIR}/lib/libfreerdp-client3.so"
    INTERFACE_INCLUDE_DIRECTORIES "${DEPS_INSTALL_DIR}/include/freerdp3"
)
add_dependencies(freerdp-client3-lib freerdp)

add_library(winpr3-lib SHARED IMPORTED GLOBAL)
set_target_properties(winpr3-lib PROPERTIES
    IMPORTED_LOCATION             "${DEPS_INSTALL_DIR}/lib/libwinpr3.so"
...
add_custom_command(
    TARGET freerdp POST_BUILD
    COMMAND ${CMAKE_COMMAND}
        -DSRC_DIR=${DEPS_INSTALL_DIR}/lib
        -DDST_DIR=${CMAKE_CURRENT_SOURCE_DIR}/../jniLibs/${CMAKE_ANDROID_ARCH_ABI}
        -P ${FREERDP_SOURCE_DIR}/client/Android/cmake/CopySharedLibs.cmake
